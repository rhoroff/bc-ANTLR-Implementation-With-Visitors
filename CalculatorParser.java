...
public class CalculatorParser extends Parser {
	...
	public static class LnExprContext extends ExprContext {
		public ExprContext ex;
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public LnExprContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitLnExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class EExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitEExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SinExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitSinExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class VarAssContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitVarAss(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DivOrTimesOrModContext extends ExprContext {
		public ExprContext el;
		public Token op;
		public ExprContext er;
		public List<ExprContext> expr() {
		...
		public DivOrTimesOrModContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitDivOrTimesOrMod(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CosExprContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitCosExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case T__21:
				...
				match(T__21);
				setState(151);
				((SinExprContext)_localctx).ex = expr(0);
				setState(152);
				match(T__13);
				 ((SinExprContext)_localctx).i =  Math.sin(((SinExprContext)_localctx).ex.i);
				}
				break;
			case T__22:
				{
				...
				match(T__22);
				setState(156);
				((CosExprContext)_localctx).ex = expr(0);
				setState(157);
				match(T__13);
				 ((CosExprContext)_localctx).i =  Math.cos(((CosExprContext)_localctx).ex.i);
				}
				break;
			case T__23:
				{
				_localctx = new LnExprContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(160);
				match(T__23);
				setState(161);
				((LnExprContext)_localctx).ex = expr(0);
				setState(162);
				match(T__13);
				 ((LnExprContext)_localctx).i =  Math.log(((LnExprContext)_localctx).ex.i);
				}
				break;
			case T__24:
				{
				...
				match(T__24);
				setState(166);
				((EExprContext)_localctx).ex = expr(0);
				setState(167);
				match(T__13);
				 ((EExprContext)_localctx).i =  Math.exp(((EExprContext)_localctx).ex.i);
				}
				break;
			case T__25:
				{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						((ExpContext)_localctx).el = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(179);
						if (!(precpred(_ctx, 12))) throw new FailedPredicateException(this, "precpred(_ctx, 12)");
						setState(180);
						((ExpContext)_localctx).op = match(T__16);
						setState(181);
						((ExpContext)_localctx).er = expr(13);
						 
						                  ((ExpContext)_localctx).i =  Math.pow(((ExpContext)_localctx).el.i, ((ExpContext)_localctx).er.i);
						              
						}
						break;
					case 2:
						{
						_localctx = new DivOrTimesOrModContext(new ExprContext(_parentctx, _parentState));
						((DivOrTimesOrModContext)_localctx).el = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(184);
						if (!(precpred(_ctx, 11))) throw new FailedPredicateException(this, "precpred(_ctx, 11)");
						setState(185);
						((DivOrTimesOrModContext)_localctx).op = _input.LT(1);
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__17) | (1L << T__18) | (1L << T__19))) != 0)) ) {
							((DivOrTimesOrModContext)_localctx).op = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
							_errHandler.reportMatch(this);
						...
						setState(186);
						((DivOrTimesOrModContext)_localctx).er = expr(12);
						 
						                  if((((DivOrTimesOrModContext)_localctx).op!=null?((DivOrTimesOrModContext)_localctx).op.getText():null).equals("*")){
						                       ((DivOrTimesOrModContext)_localctx).i = ((DivOrTimesOrModContext)_localctx).el.i*((DivOrTimesOrModContext)_localctx).er.i;
						                  } 
						                  if((((DivOrTimesOrModContext)_localctx).op!=null?((DivOrTimesOrModContext)_localctx).op.getText():null).equals("/")){
						                      ((DivOrTimesOrModContext)_localctx).i = ((DivOrTimesOrModContext)_localctx).el.i/((DivOrTimesOrModContext)_localctx).er.i;
					...
					case 3:
						...
						((AddOrSubContext)_localctx).el = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(189);
						...
						setState(191);
						((AddOrSubContext)_localctx).er = expr(11);
						 
						                  if((((AddOrSubContext)_localctx).op!=null?((AddOrSubContext)_localctx).op.getText():null).equals("+")){
						                       ((AddOrSubContext)_localctx).i = ((AddOrSubContext)_localctx).el.i+((AddOrSubContext)_localctx).er.i;
						                  } 
						                  if((((AddOrSubContext)_localctx).op!=null?((AddOrSubContext)_localctx).op.getText():null).equals("-")){
						                      ((AddOrSubContext)_localctx).i = ((AddOrSubContext)_localctx).el.i-((AddOrSubContext)_localctx).er.i;
						                  }
	...
	public static final String _serializedATN =
		...
